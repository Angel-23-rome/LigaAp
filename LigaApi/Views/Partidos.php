        ...
        <div class="card">
            ...
            <div class="row">
                ...
                if(isset($_POST['filtro'])){
                    ...
                    $WHERE= "WHERE eq.idEquipo=".$equipoFiltro;
                }else{
                    $WHERE="";
                }
                if (isset($_POST['limpiar'])) {
                    $WHERE="";
                            ...
                            include_once '../Models/Conexion.php';
                            $sql = "SELECT jug.idJugador,concat(jug.Nombre_J,' ',jug.Apellido_J) AS NombreJugador, jug.Peso_J,jug.Altura_J,
                            jug.Curp_J, eq.idEquipo,eq.Nombre_E, jug.Tipo_J ,jug.Posicion_J,jug.Comunidad_J
                            FROM jugadores jug INNER JOIN equipos eq ON jug.Equipo_J = eq.idEquipo ".$WHERE;
                            $result = $pdo->query($sql);
                            ...
                            while ($filas= $result->fetch()) {
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h6><?php echo $filas[1]." "."(".$filas[6].")"?></h6>
                                    </div>
                                    <div class="card-body">
                                    <h5 class="text-center">Información</h5>
                                        <div class="row">
                                            ...
                                            <h6><b>Peso: </b><?php echo $filas[2]?> Kg</h6>
                                            <h6><b>Altura: </b><?php echo $filas[3]?> M</h6>
                                            <h6><b>Tipo: </b><?php echo $Tipo?> </h6>
                                            </div>
                                            <div class="col-4">
                                            <h6><b>Posición </b><?php echo $filas[8]?></h6>
                                            <h6><b>Comunidad </b><?php echo $filas[9]?></h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a class="btn btn-info">Generar Credencial</a>
                                    </div>
                                </div>
                                </div>
                        <?php
